...
$imgOffer=Get-AzureRmVMImageOffer -Location westus -PublisherName canonical | ? {$_.Offer -like "UbuntuServer*"}
$SKU=Get-AzureRmVMImageSku -Location westus -PublisherName canonical -Offer $imgOffer.Offer | ? {$_.Skus -eq "16.04.0-LTS"}
$SKU=$SKU.Skus
...
$vmConfig = Set-AzureRmVMSourceImage -VM $vmConfig -PublisherName $SKU.PublisherName -Offer $imgOffer.Offer -Skus $SKU -Version latest
$vmConfig = Set-AzureRmVMPlan -VM $vmConfig -Publisher $SKU.PublisherName -Product $imgOffer.Offer -Name $SKU
